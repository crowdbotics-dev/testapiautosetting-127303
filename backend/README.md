...
## Project Structure
    ...
    ├── testapiautosetting_127303  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127303`
...
2. Clone this repo and `cd testapiautosetting_127303`
